...
class LihatStatusLaundry extends StatelessWidget {
  const LihatStatusLaundry({super.key});

  @override
  Widget build(BuildContext context) {
    final List<_StepStatus> steps = [
      _StepStatus('Pesanan Anda telah diterima', true),
      _StepStatus('Sedang menyiapkan pesanan Laundry Anda', true),
