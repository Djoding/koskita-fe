...
class PenghuniLoginScreen extends StatefulWidget {
  ...
  const PenghuniLoginScreen({super.key, this.userRole = ''});

  @override
  State<PenghuniLoginScreen> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<PenghuniLoginScreen> {
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            ...
            Get.to(() => const PenghuniLoginWithGoogle());
          },
          child: Container(
            width: 40,
            height: 40,
  ...
  Widget _buildPasswordScreen() {
    return Column(
      children: [
        ...
        TextButton(
          onPressed: () {
            Get.to(() => const PenghuniForgetpasswordScreen());
          },
          child: Text(
            'Lupa Password?',
            style: GoogleFonts.poppins(
