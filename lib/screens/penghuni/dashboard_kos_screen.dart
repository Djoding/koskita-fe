...
class _KosScreenState extends State<KosScreen>
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(
        0xFFE0F2F7,
      ), // A lighter, more modern background
      body: SafeArea(
        child: Column(
          children: [
            _buildHeader(),
  ...
  Widget _buildHeader() {
    return Container(
      decoration: const BoxDecoration(
        color: Color(0xFF91B7DE), // Original background color for header
        ...
        children: [
          ...
          Column(
            ...
            children: [
              ...
              Text(
                'Temukan dan reservasi kos dengan mudah.', // More inviting text
                style: GoogleFonts.poppins(
  ...
  Widget _buildCircularIconButton({
    ...
    return Container(
      ...
      height: 48, // Slightly larger button
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(3), // More rounded corners
        boxShadow: [
          BoxShadow(
      ...
      child: TabBar(
        ...
        labelStyle: GoogleFonts.poppins(
          ...
          fontSize: 14, // Slightly smaller font for tabs
        ),
        ...
        tabs: [
          ...
          Tab(
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15.0),
              child: Text(
                'Kos Aktif (${activeKostList.length})',
              ), // Shorter text
            ),
          ),
          Tab(
            child: Padding(
              padding: const EdgeInsets.symmetric(horizontal: 15.0),
              child: Text(
                'Riwayat (${historyReservedKostList.length})', // Shorter text
              ),
            ),
          ),
        ],
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Text(
              'Coba cari dengan kata kunci lain atau periksa tab lainnya.', // Helpful hint
...
class _KostCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return AnimatedContainer(
      // Added AnimatedContainer for subtle animation
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            ...
            offset: const Offset(0, 6), // More pronounced shadow
          ),
        ],
      ),
      child: Material(
        // Use Material for ripple effect
        ...
        child: InkWell(
          ...
          highlightColor: const Color(
            0xFF119DB1,
          ).withOpacity(0.05), // Custom highlight color
          child: Padding(
            padding: const EdgeInsets.all(20), // Increased padding inside card
            child: Row(
              crossAxisAlignment:
                  CrossAxisAlignment.start, // Align items to the start
              children: [
                Hero(
                  // Added Hero animation for image
                  tag: 'kost-image-${kost['nama']}', // Unique tag
                  child: ClipRRect(
                    ...
                    child: Image.asset(
                      ...
                      errorBuilder:
                          (context, error, stackTrace) => Container(
                            ...
                            child: Icon(
                              Icons.broken_image, // More descriptive error icon
                              size: 45,
                              color: Colors.grey[400],
                            ),
                          ),
                    ...
                    children: [
                      Text(
                        ...
                        style: GoogleFonts.poppins(
                          ...
                          fontSize: 18, // Slightly larger font
                          color: Colors.blueGrey[800], // Darker text
                        ),
                      ...
                      Text(
                        ...
                        maxLines: 2, // Allow two lines for address
