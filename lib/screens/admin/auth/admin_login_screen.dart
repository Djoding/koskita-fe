...
import 'package:kosan_euy/screens/admin/auth/admin_forgetpassword_screen.dart';
import 'package:kosan_euy/screens/admin/auth/admin_login_with_google.dart';
import 'package:kosan_euy/screens/admin/dashboard_admin.dart';

class AdminLoginScreen extends StatefulWidget {
  final String userRole;
  const AdminLoginScreen({super.key, this.userRole = ''});
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            ...
            Get.to(() => const AdminLoginWithGoogle());
          },
          child: Container(
            width: 40,
            height: 40,
