...
import 'status_laundry.dart';

class CekStatusLaundryScreen extends StatelessWidget {
  const CekStatusLaundryScreen({super.key});

  @override
  Widget build(BuildContext context) {
    // Data dummy pesanan laundry
    final List<Map<String, String>> pesananMasuk = [
      {'nama': 'Yena Anggraeni', 'tanggal': '6 Mei 2025'},
    ];
                  ...
                  return Padding(
                    ...
                    child: Material(
                      ...
                      child: InkWell(
                        ...
                        onTap: () {
                          Get.to(() => const StatusLaundryScreen());
                        },
                        child: Container(
                          decoration: BoxDecoration(
                            color: Colors.white,
