...
class AddLayananLaundryScreen extends StatelessWidget {
  const AddLayananLaundryScreen({super.key});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Center(
                child: Text(
                  'Silahkan Isi Data Layanan Laundry',
                  style: TextStyle(
                    color: Colors.white,
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    onPressed: () {
                      Get.to(
                        () => const SuccessScreen(
                          title: 'Layanan Laundry Berhasil Ditambahkan',
                        ),
                      );
                    },
