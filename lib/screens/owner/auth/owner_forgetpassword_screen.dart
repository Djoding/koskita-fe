...
class OwnerForgetpasswordScreen extends StatefulWidget {
  const OwnerForgetpasswordScreen({super.key});

  @override
  State<OwnerForgetpasswordScreen> createState() =>
      _ForgetPasswordScreenState();
}

class _ForgetPasswordScreenState extends State<OwnerForgetpasswordScreen> {
            ...
            actions: [
              TextButton(
                onPressed: () {
                  ...
                  Get.offAll(() => const OwnerLoginScreen());
                },
                child: const Text('OK'),
              ),
            ],
