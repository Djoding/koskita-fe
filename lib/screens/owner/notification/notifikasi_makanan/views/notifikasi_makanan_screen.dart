...
class NotifikasiMakananScreen extends StatelessWidget {
  const NotifikasiMakananScreen({super.key});
      ...
      body: SafeArea(
        child: Column(
          ...
          children: [
            ...
            Center(
              child: Text(
                'Semua Layanan Pesanan Makanan/Minuman',
                style: TextStyle(
                  color: Colors.white,
              ...
              child: Column(
                children: [
                  _MenuButton(
                    title: 'Pesanan Masuk',
                    onTap: () {
                      Get.to(() => const PesananMasukScreen());
                    },
                  ),
                  ...
                  _MenuButton(
                    ...
                    onTap: () {
                      Get.to(() => const ResiPesananScreen());
                    },
                  ),
                ],
              ),
