...
class DetailPesananMasukMakananScreen extends StatelessWidget {
  final Map<String, String> pesanan;

  const DetailPesananMasukMakananScreen({super.key, required this.pesanan});

  @override
  Widget build(BuildContext context) {
    final List<Map<String, String>> daftarPesanan = [
      {
                    ...
                    Expanded(
                      child: ElevatedButton(
                        onPressed: () {
                          ...
                          Get.snackbar(
                            'Pesanan Ditolak',
                            'Pesanan ${pesanan['nama']} telah ditolak',
                        ...
                        onPressed: () {
                          Get.to(
                            () => const SuccessScreen(
                              ...
                              subtitle:
                                  'Pesanan telah dipindahkan ke status diproses',
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
