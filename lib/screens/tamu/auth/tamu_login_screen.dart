...
import 'package:kosan_euy/screens/tamu/auth/tamu_forgetpassword_screen.dart';
import 'package:kosan_euy/screens/tamu/auth/tamu_login_with_google.dart';
import 'package:kosan_euy/screens/tamu/dashboard_tamu.dart';

class TamuLoginScreen extends StatefulWidget {
  final String userRole;
  const TamuLoginScreen({super.key, this.userRole = ''});

  @override
  State<TamuLoginScreen> createState() => _LoginScreenState();
}

class _LoginScreenState extends State<TamuLoginScreen> {
      ...
      children: [
        ...
        InkWell(
          onTap: () {
            ...
            Get.to(() => const TamuLoginWithGoogle());
          },
          child: Container(
            width: 40,
            height: 40,
  ...
  Widget _buildPasswordScreen() {
    return Column(
      children: [
        ...
        TextButton(
          onPressed: () {
            Get.to(() => const TamuForgetpasswordScreen());
          },
          child: Text(
            'Lupa Password?',
            style: GoogleFonts.poppins(
