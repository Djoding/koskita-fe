...
import 'package:kosan_euy/screens/tamu/pembayaran/menu_pembayaran_tamu.dart';

class ReservasiKosTamu extends StatefulWidget {
  const ReservasiKosTamu({super.key});

  @override
  State<ReservasiKosTamu> createState() => _ReservasiKosScreenState();
}

class _ReservasiKosScreenState extends State<ReservasiKosTamu> {
  int _currentIndex = 0;
  int _jumlah = 1;
                  ...
                  Center(
                    child: SizedBox(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Get.to(() => MenuPembayaranTamuScreen());
                        },
